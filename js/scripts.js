$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Abhishek and Sagun's Wedding",
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    if (
      ...
      $.post(
        "https://script.google.com/macros/s/AKfycbzrmFVZQ2gwXPsNihVHXM29k6sBDfL4GcUSaG3N/exec",
        data
      )
        .done(function (data) {
          console.log(data);
...
// Google map
function initMap() {
  var location = { lat: 27.53559793978064, lng: 76.60743888388582 };
